...
class Counter extends Component {
 ...
 return setInterval(() =>{
   ...
   if(this.props.strMinutes === 60) {
    ...
    this.setState({
        time: (`${this.props.strHours}:${this.props.strMinutes}:${this.props.strSeconds += 1} ${ampm}`),
      });
    }, 1000);
}
...
render() {
    return (
      <div className="clock">
        ...
        <div className="clock__time">{this.getTimeWithOffsetFormatted().toLocaleString()}</div>
      </div>
    )
  }
}
